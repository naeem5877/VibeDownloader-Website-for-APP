      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="neo-card hover-lift overflow-hidden transition-all duration-500">
              <CardContent className="p-8">
                <div className="flex flex-col items-center text-center">
                  <div className="w-20 h-20 bg-gradient-to-br from-vibeSecondary/20 to-transparent rounded-2xl flex items-center justify-center mb-6 shimmer">
                    <img src={feature.icon} alt={feature.title} className="w-12 h-12 invert opacity-70" />
                  </div>
